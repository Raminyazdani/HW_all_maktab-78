...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ASUS\Desktop\git\password_gen\password_gen\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ASUS\Desktop\git\password_gen\password_gen\venv\Scripts\deactivate.nu'
